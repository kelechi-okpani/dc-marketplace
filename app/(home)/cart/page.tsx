...
export default function CartPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 antialiased py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 h-[350px] w-[350px] rounded-full bg-gradient-to-br from-[#1877F2]/10 to-[#1877F2]/5 blur-[100px] pointer-events-none z-0" />
      <div className="absolute bottom-12 left-[-50px] h-[300px] w-[300px] rounded-full bg-gradient-to-tr from-[#1877F2]/5 to-[#1877F2]/10 blur-[90px] pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <header className="border-b border-slate-200/80 pb-6 mb-10">
          <h1 className="text-2xl sm:text-3xl font-black tracking-tight text-slate-950 flex items-center gap-3">
            <div className="h-10 w-10 rounded-xl bg-[#1877F2] text-white flex items-center justify-center shadow-md shadow-[#1877F2]/20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-8 space-y-4">
              {cartItems.map((item) => (
                <div 
                  key={item.id} 
                  className="bg-white border border-slate-200/80 rounded-2xl p-4 sm:p-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 shadow-xs hover:border-[#1877F2]/30 hover:shadow-lg hover:shadow-[#1877F2]/5 transition-all duration-300 group/row"
                >
                  <div className="flex items-center gap-4 w-full sm:w-auto">
                    <div className="relative h-20 w-20 bg-slate-50 border border-slate-100 rounded-xl overflow-hidden shrink-0 shadow-inner group-hover/row:border-[#1877F2]/30 transition-colors">
                      <Image 
                        src={item.imageUrl} 
                        alt={item.title} 
                        fill
                  ...
                  <div className="flex items-center justify-between sm:justify-end w-full sm:w-auto gap-6 border-t sm:border-t-0 pt-4 sm:pt-0 border-slate-100">
                    <div className="flex items-center border border-slate-200 rounded-xl bg-slate-50/80 p-0.5 shadow-2xs">
                      <button 
                        ...
                        className="p-2 text-slate-400 hover:text-[#1877F2] hover:bg-white rounded-lg transition-all cursor-pointer shadow-none hover:shadow-xs active:scale-90"
                      >
            ...
            <aside className="lg:col-span-4 bg-white border border-slate-200 rounded-3xl p-6 shadow-xl shadow-slate-200/40 space-y-6 relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-bl from-[#1877F2]/5 to-transparent rounded-full blur-xl pointer-events-none" />
              
              <div className="flex items-center gap-2.5 pb-2">
                <div className="h-8 w-8 rounded-lg bg-[#E7F3FF] text-[#1877F2] flex items-center justify-center border border-[#1877F2]/20">
              ...
              <div className="space-y-3 border-t border-b border-slate-100 py-4">
                ...
                <div className="flex justify-between items-center text-xs font-bold text-slate-500">
                  ...
                  <span className="text-[#1877F2] font-black tracking-widest text-[9px] bg-[#E7F3FF] border border-[#1877F2]/20 px-2 py-0.5 rounded-md uppercase">
                    FREE
                  </span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between pt-1">
                ...
                <span className="text-2xl font-black text-slate-950 tracking-tight bg-gradient-to-r from-slate-950 to-blue-900 bg-clip-text text-transparent">
                  {formatNaira(cartTotal)}
                </span>
              </div>

              <div className="space-y-3 pt-2">
                <button className="w-full bg-[#1877F2] hover:bg-[#166fe5] text-white font-black text-xs uppercase tracking-widest py-3.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all shadow-md shadow-[#1877F2]/20 active:scale-99 cursor-pointer group">
                ...
                <div className="flex gap-3 bg-[#E7F3FF]/40 p-4 rounded-xl border border-[#1877F2]/10 text-[11px] leading-relaxed text-slate-500 font-medium">
                  <ShieldCheck className="h-4 w-4 text-[#1877F2] shrink-0 mt-0.5 animate-pulse" />
                  <p>
