...
export default function StoreFrontPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="bg-[#f1f5f9] min-h-screen pb-16 font-sans text-slate-800 antialiased selection:bg-blue-600 selection:text-white">
      ...
      <div className="max-w-[1400px] mx-auto px-4 mt-4 space-y-4">
        ...
        <div className={`relative rounded-xl bg-blue-700 ${merchant.bannerColor} text-white p-6 md:p-8 shadow-md overflow-hidden`}>
            ...
            <div className="flex items-start md:items-center gap-4">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {merchant.isOfficial && (
                    <span className="inline-flex items-center gap-1 bg-white text-blue-600 text-[10px] font-black uppercase px-2 py-0.5 rounded-full shadow-2xs">
                      <CheckCircle className="h-3 w-3 fill-blue-600 text-white" /> Official Store
                    </span>
                  )}
                </div>
                <p className="text-xs text-blue-50 font-bold tracking-wide flex items-center gap-1.5">
            ...
            <div className="space-y-2 pt-3 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-2">
                <input
                  ...
                  className="w-full p-2 text-xs font-bold rounded-lg bg-slate-50 border border-slate-200 focus:outline-hidden focus:bg-white focus:border-blue-600 shadow-2xs"
                />
                <input
                  type="number"
                  placeholder="Max"
          ...
          <section className="md:col-span-3 space-y-4">
            ...
            <div className="bg-white rounded-xl border border-slate-200 px-4 py-2.5 flex items-center justify-between shadow-xs">
              <p className="text-xs font-medium text-slate-500">
                Viewing items <span className="font-bold text-slate-800">{recordMetrics.start}</span> - <span className="font-bold text-slate-800">{recordMetrics.end}</span> of <span className="font-black text-blue-600">{recordMetrics.total}</span> merchant products loaded
              </p>
            </div>
