...
export default function ProductCard({ product, viewMode, onViewDetails, onAddToCart }: ProductCardProps) {
  ...
  return (
    <div className={`group bg-white border border-2 border-blue-500 transition-all duration-300 hover:shadow-lg hover:border-[#1877F2]/30 ${isGrid ? 'rounded-lg p-2 flex flex-col' : 'rounded-xl p-3 flex flex-row gap-4'}`}>
