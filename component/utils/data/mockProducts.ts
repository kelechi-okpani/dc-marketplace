...
export interface Product {
  ...
  merchantId?: string; // Links products back to their unique registry owners
}
...
export const MOCK_STORES_DATABASE: Record<string, { merchant: MerchantProfile; categories: string[] }> = {
  "aeon-appliances-nigeria": {
    merchant: {
      ...
      storeName: "Aeon Official Store",
      isOfficial: true,
      score: "96% Quality Score",
      followers: "32.8K Followers",
      location: "Lagos, Nigeria",
      joinedDate: "Member since 2021",
      verifiedStatus: "Certified Brand Manufacturer",
      bannerColor: "from-[#F6921E] to-[#d67b13]",
      description: "Welcome to the Official Aeon Home Appliances store. Shop premium cooling systems, smart electronics, and household gear engineered with state-of-the-art power-saving capacities."
    },
    categories: ['appliances', 'electronics', 'computing'] 
  },
  "slot-matrix-phones": {
    merchant: {
      id: "slot-matrix-phones",
      storeName: "Phones Deal Hub",
      isOfficial: false,
      score: "91% Quality Score",
      followers: "12.4K Followers",
      location: "Abuja, Nigeria",
      joinedDate: "Member since 2023",
      verifiedStatus: "Top Tier Phone Vendor",
      bannerColor: "from-blue-600 to-indigo-800",
      description: "Your authorized depot for authentic international smartphones, tablets, and mobile essential accessories with straight manufacturer guarantees."
    },
    categories: ['phones-tablets', 'gaming', 'computing']
  }
};
...
export const mainCategories = [
  ...
  { id: 'computing', label: 'Computing', subCats: ['Laptops', 'Desktops', 'Printers', 'Data Storage'] },
  { id: 'baby-products', label: 'Baby Products', subCats: ['Diapering', 'Baby Food', 'Toys', 'Strollers'] },
  { id: 'gaming', label: 'Gaming', subCats: ['PlayStation', 'Xbox', 'Nintendo', 'Gaming Accessories'] },
  { id: 'other-categories', label: 'Other categories', subCats: ['Automotive', 'Books', 'Musical Instruments'] },
];




// Mock comprehensive product dataset mapped to your CategoryViewScreen schemas
export const mockProductDetails = {
  id: 'prod-1092',
  title: 'SwiftPad X1 Pro Laptop - 16GB RAM, 512GB SSD Integrated Matrix',
  brand: 'SwiftPad',
  
  // Core structural requirements matching your CategoryViewScreen filter layers
  category: 'computing',                  // Maps directly to cat.id inside mainCategories registry
  subCategory: 'Laptops',                 // Populates your dynamic subcategory counter sidebar
  isOfficialStore: true,                  // Triggers validation when p.isOfficialStore runs
  
  rating: 4.8,                            // Handled perfectly by your 'rating' sort layer
  reviewCount: 154,
  
  // Normalized pricing structures matching: dataset.filter(p => p.price >= Number(minPrice))
  price: 450000,                          // Swapped from basePrice to price for your calculation matrix
  originalPrice: 500000,
  discountPercentage: 10,
  
  stockStatus: 'Few units left',
  shippingInfo: {
    estimation: 'Est. delivery: Oct 25-28 to Abuja / Lagos',
    baseCost: 2500,
    returnPolicy: 'Free returns within 7 days.'
  },
  merchant: {
    name: 'TechHaven Nigeria',
    slug: 'techhaven-nigeria',
    avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=100&q=80'
  },
  images: [
    'https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&w=800&q=80', // Primary View
    'https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&w=800&q=80', // Detail Angle
    'https://images.unsplash.com/photo-1603302576837-37561b2e2302?auto=format&fit=crop&w=800&q=80'  // Closed shell profiles
  ],
  variations: ['Standard Matte Grey', 'Midnight Silver Accent'],
  crossSell: {
    title: 'NairaMarket Protect - Extended Device Insurance',
    price: 18000,
    logoText: 'AXA'
  },
  description: 'SwiftPad X1 Pro Laptop - 16GB RAM, 512GB SSD is a magnificent, performance-focused state for full-time productivity and straight, ultra-responsive computing power. Engineered with thin, lightweight aesthetics, a stunning immersive display panel, and robust long-lasting battery runtimes, it flawlessly handles intense development environments, creative pipelines, and day-to-day administrative frameworks.',
  specifications: [
    { label: 'Processor', value: 'Intel Core i7 12th Gen / Ryzen 7 Equivalent' },
    { label: 'System Memory', value: '16GB LPDDR5 Dual Channel' },
    { label: 'Storage Footprint', value: '512GB NVMe M.2 Solid State Drive' },
    { label: 'Display Metrics', value: '14.2" IPS QHD (2560x1600) 90Hz' },
    { label: 'Operating System', value: 'Windows 11 Pro Signature Edition' }
  ]
};
