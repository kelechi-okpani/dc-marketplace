export const categories = [
  ...
  { id: 13, name: "Food, Agriculture & Farming", icon: "/jiji/agriculture.png", totalItems: 128500,
     subcategories: [
      { id: 1301, name: "FMCG Products", icon: "🍞", count: 110000 },
      { id: 1302, name: "Agro-Inputs & Livestock", icon: "🐄", count: 18500 },
      { id: 1304, name: "Food & Drink", icon: "🛒", count: 1500 },
  ]},
  { id: 14, name: "Animals & Pets", icon: "/jiji/animals.png", totalItems: 14200,
     subcategories: [
...
const CATEGORY_MAP: Record<string, number> = {
  ...
  'Phones & Tablets': 3,
  'Electronics': 4,
  'Home, Furniture & Appliances': 5,
  'Fashion': 6,
  'Beauty & Personal Care': 7,
  'Services': 8,
  'Repair & Construction': 9,
  'Commercial Equipment & Tools': 10,
  'Leisure & Activities': 11,
  'Babies & Kids': 12,
  'Food, Agriculture & Farming': 13,
  'Animals & Pets': 14,
  'Jobs': 15,
  'Seeking Work - CVs': 16,
  'Health & Medical': 17,
